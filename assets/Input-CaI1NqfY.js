import{j as r}from"./index-DwfKsHWR.js";const a=({label:e,id:o,containerClassName:d="",className:t="",...i})=>r.jsxs("div",{className:`w-full ${d}`,children:[e&&r.jsx("label",{htmlFor:o,className:"block text-sm font-medium text-foreground dark:text-dark-foreground mb-1.5",children:e}),r.jsx("input",{id:o,className:`flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground
