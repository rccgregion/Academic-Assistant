import{u as r}from"./index-CL7HjhdV.js";const l=({label:e,id:d,containerClassName:o="",className:a="",...i})=>r.jsxs("div",{className:`w-full ${o}`,children:[e&&r.jsx("label",{htmlFor:d,className:"block text-sm font-medium text-foreground dark:text-dark-foreground mb-1.5",children:e}),r.jsx("input",{id:d,className:`flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground
