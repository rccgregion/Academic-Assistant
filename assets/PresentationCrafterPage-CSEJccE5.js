import{l as O,o as I,q as $,m as A,r as d,j as e,P as j,c as p,t as D,a as E}from"./index-Cf9C7PVC.js";import{C as g}from"./Card-C8Vt2KLr.js";import{g as R,p as B}from"./geminiService-DJIPhCmJ.js";import{d as G}from"./downloadHelper-Y0t7dfPR.js";const J=()=>{const{settings:h}=O(),n=I(),{addToast:o}=$(),{openSaveToDriveModal:N}=A(),[i,x]=d.useState(""),[a,m]=d.useState(null),[l,y]=d.useState(!1),[f,c]=d.useState(null),[F,k]=d.useState(void 0);d.useEffect(()=>{var r;if((r=n.state)!=null&&r.initialText){x(n.state.initialText),n.state.documentName&&k(n.state.documentName);const t=n.state.documentName?` from "${n.state.documentName}"`:"";o(`Project text loaded${t} for Presentation Crafter.`,"info"),window.history.replaceState({},document.title)}},[n.state,o]);const w=d.useCallback(async()=>{if(!i.trim()){c("Please paste your project text to generate a presentation outline."),o("Project text is empty.","warning");return}y(!0),c(null),m(null);const r=`You are an expert academic presentation designer. Based on the following project text, generate a structured outline for a PowerPoint-style presentation.
